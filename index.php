        ...
        <div class="container">
            <div class="col">
                ...
                <h1 class="default_style_catchy_header header">
                    <?php echo generateCatchyHeaderHTML("Speechify's internal discussion space."); ?>
                </h1>
                <p class="animated" style="opacity: 0;"><?php include "assets/txt/site_title.txt"; ?> is a platform to suggest ideas, make comments, and discuss all things <?php  include "assets/txt/school_name.txt"; ?>.</p>
