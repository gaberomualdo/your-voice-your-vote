...
window.addEventListener("load", () => {
    // header animation
    document.querySelector("body > div.container > div.block:first-child > div.row:first-child > h1.header:first-child").classList.add("animation_shown");

    // description and form animation (in) goes after header animation is done (can be checked with last word transition time)
    const headerTransitionTimeMilliseconds = parseInt(document.querySelector("body > div.container > div.block:first-child > div.row:first-child > h1.header:first-child > span.word_container:last-child > span.word_animated").style.transitionDelay.split("s")[0]) + 0.625;
...
document.querySelector("body > div.container > div.block:first-child > div.row:nth-child(2) > div.form > div.button_container > button").addEventListener("click", function() {
    ...
    const submitAnonymouslyInputElement = document.querySelector("body > div.container > div.block > div.row:nth-child(2) > div.form > div.button_container > div.submit_anon_checkbox > input[type=checkbox]");
    ...
    if(titleInputElement.value.length == 0) {
        ...
        // add to database
        databaseObj.ref("submission_platform/").push({
            ...
            document.querySelector("body > div.container > div.block:first-child > div.row:first-child > h1.header:nth-child(2)").style.display = "block";

            // animate (in) second header and show space for description/extra-text after 0.025 seconds
            setTimeout(() => {
                document.querySelector("body > div.container > div.block:first-child > div.row:first-child > h1.header:nth-child(2)").classList.add("animation_shown");
            ...
            const headerTransitionTimeMilliseconds = parseInt(document.querySelector("body > div.container > div.block:first-child > div.row:first-child > h1.header:nth-child(2) > span.word_container:last-child > span.word_animated").style.transitionDelay.split("s")[0]) + 0.65;
